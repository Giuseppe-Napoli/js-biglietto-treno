...
var età = parseInt(prompt ('Età passeggero?'));
if(isNaN(età)){
...
document.getElementById('passeggero').innerHTML = "Gentile Passeggero, il prezzo previsto per il suo viaggio è di " + sconto.toFixed(2) + "€"; 
